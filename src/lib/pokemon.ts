...
export const POKEMON_TYPE_CLASSES: Record<string, { base: string; hover: string; textClass: string }> = {
  ...
  water: { base: 'bg-rose-400', hover: 'hover:bg-rose-500', textClass: 'text-white' }, 
  ...
  rock: { base: 'bg-amber-700', hover: 'hover:bg-amber-800', textClass: 'text-white' }, 
  ...
  unknown: { base: 'bg-gray-500', hover: 'hover:bg-gray-600', textClass: 'text-white' },
};
