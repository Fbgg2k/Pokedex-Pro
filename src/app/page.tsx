    ...
    <div className="space-y-8">
      ...
      {selectedTypesArray.length > 0 && pokemon.length === 0 && !totalCount && (
        <Alert variant="default" className="max-w-xl mx-auto bg-card shadow-md">
          ...
          <AlertTitle className="text-destructive"></AlertTitle>
          <AlertDescription>
            Não foram encontrados Pokémon com a combinação de tipos selecionada: {selectedTypesArray.map(type => capitalize(type)).join(', ')}.
          </AlertDescription>
        </Alert>
      )}
